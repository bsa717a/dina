...
const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    content:
      "Morning briefing (<2 min): 1) Today's Win (one meaningful outcome) 2) Needs Your Attention (highest priority; why, recommendation, next action) 3) Calendar (meetings, travel, prep, conflicts) 4) Waiting On (Derek waiting / waiting on Derek) 5) Projects needing attention 6) Personal (family, church, health, reminders) 7) Opportunities (automation, delegation, simplification, buy vs build).",
    importance: "critical",
    confidence: 1,
  },
  {
